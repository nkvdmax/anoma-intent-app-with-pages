    ...
    <header className="sticky top-0 z-40 backdrop-blur-md bg-black/30 border-b border-white/10">
      <div className="section py-4 flex items-center justify-between">
        <a href="/" className="flex items-center gap-3">
          <img src="/img/anoma-hood.png" alt="Anoma" className="h-9 w-9 rounded-lg border border-brand-500/40 drop-shadow-redglow object-cover" />
        ...
        <nav className="hidden sm:flex items-center gap-2">
          ...
          <a className="btn" href="https://github.com/nkvdmax/anoma-intent-app-with-pages" target="_blank" rel="noreferrer">GitHub</a>
        </nav>
      </div>
    </header>
  );
